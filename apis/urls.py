...
urlpatterns = [
    ...
    path("myblogs/create", create_blog, name="create_blog"),
    path("myblogs/delete/<int:id>", delete_blog, name="delete_blog"),
    path("myblogs/edit/<int:id>", edit_blog, name="edit_blog"),
    path("modblogs", mod_blogs, name="mod_blogs"),
    path("admin_page", only_admin, name="admin"),
